...
export const ChannelSimulator: React.FC<ChannelSimulatorProps> = ({
  ...
  return (
    <div className="rounded-xl bg-white dark:bg-zinc-900/60 border border-zinc-200 dark:border-white/10 p-4 lg:p-5 shadow-sm flex flex-col gap-4 transition-colors">
      {/* 头部标题 */}
      <div className="flex items-center justify-between pb-3 border-b border-zinc-200 dark:border-white/10 flex-wrap gap-2">
        ...
        <span className="text-[11px] font-mono text-zinc-500 dark:text-zinc-400 whitespace-nowrap flex-shrink-0">
          主动推送 · 现场技师移动端审批
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* 钉钉 ActionCard 仿真 */}
        <div className="rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-white/10 p-4 flex flex-col justify-between shadow-sm transition-colors">
          <div>
            ...
            <div className="text-xs text-zinc-700 dark:text-zinc-300 space-y-1.5 leading-relaxed">
          ...
          <div className="mt-4 pt-3 border-t border-zinc-200 dark:border-white/5">
            {isApproved ? (
              <div className="w-full py-2 px-3 rounded bg-emerald-100 dark:bg-emerald-500/10 border border-emerald-300 dark:border-emerald-500/30 text-emerald-700 dark:text-emerald-400 text-xs font-semibold flex items-center justify-center gap-1.5 whitespace-nowrap">
