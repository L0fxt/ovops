...
📖 **项目完整路线图与多角色架构规范**：详见 [ROADMAP.md](./ROADMAP.md)
...
| **专家经验难以传承**：排查高度依赖老技师，非结构化经验散落各处。 | **专家 SOP 规程 RAG**：沉淀永嘉流体装备骨干制造厂权威排障手册，毫秒级语义匹配。 |
